                    ...
                    if response.json()['timeslotsFree'][i]['percentAvailable'] > 0:
                        ...
                        for j, percents in enumerate(response2.json()['timeslotsFree']):
                            if response2.json()['timeslotsFree'][j]['percentAvailable'] > 0:
                                ...
                                if (delta.days < 50):
                                    print("Vaccination center: " + str(key[0]) + " Postal Code: " + str(key[2]) + " available date of 1st vaccination " + response.json()['timeslotsFree'][i]['onDate'] + " Days between vaccination appointments " + str(delta.days))
